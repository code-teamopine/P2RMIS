...
namespace Sra.P2rmis.Dal
{
    public partial interface IUnitOfWork
    {
        ...
        IPolicyWeekDayHistoryRepository PolicyWeekDayHistoryRepository { get; }
        IPolicyNetworkRangeHistoryRepository PolicyNetworkRangeHistoryRepository { get; }
        IPolicyStatusRepository PolicyStatusRepository { get; }
    }
}
